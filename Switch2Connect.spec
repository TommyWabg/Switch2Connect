...
hiddenimports = ['driver_install_helper', 'imufusion', 'hid', 'usb.core', 'usb.util', 'libusb_package', 'usb_hid_controller', 'hidhide', 'usbip_server', 'usbip_dualsense_server', 'dualsense_descriptors', 'dualsense_structs', 'dualsense_haptic', 'audio_endpoint_guard', 'comtypes', 'comtypes.client', 'comtypes.automation']
