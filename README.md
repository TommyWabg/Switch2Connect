...
* **USB Connected Switch 2 Pro Controller Support:** Added wired support for the Nintendo Switch 2 Pro Controller via USB connection.
  ...
  ***Known Issue:* Utilizing DualSense Audio Haptics with the USB-connected Switch 2 Pro Controller currently causes vibration signal congestion and application crashes. Optimization is in progress.***
...
* **USBIP PS5 Audio Device Management:** Integrated svcl.exe to automatically disable the "Wireless Controller Audio" audio device in the Windows system sound settings when using the PS5 Audio Haptics feature over USBIP, ensuring haptic feedback operates without interference.
