...
* **Extra Button Remapping:** Fully remap extra buttons like `GL`, `GR`, `SL_R`, `SR_R`, `SL_L`, `SR_L`, `Home`, `Capture`, and `Chat` to function as gyro trigger, DualShock/DualSense trackpad click, calibration trigger, or standard buttons.
